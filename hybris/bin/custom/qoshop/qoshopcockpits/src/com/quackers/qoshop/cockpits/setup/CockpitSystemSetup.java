 ...
 */
package com.quackers.qoshop.cockpits.setup;
...
import com.quackers.qoshop.cockpits.constants.QoshopCockpitsConstants;
 ...
 */
@SystemSetup(extension = QoshopCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(QoshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(QoshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						QoshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/qoshopcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
