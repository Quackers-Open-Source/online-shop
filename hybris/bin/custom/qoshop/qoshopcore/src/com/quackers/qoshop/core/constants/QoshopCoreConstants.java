 ...
 */
package com.quackers.qoshop.core.constants;

/**
 * Global class for all QoshopCore constants. You can add global constants for your extension into this class.
 */
public final class QoshopCoreConstants extends GeneratedQoshopCoreConstants
{
	public static final String EXTENSIONNAME = "qoshopcore";


	private QoshopCoreConstants()
	{
		//empty
	}
