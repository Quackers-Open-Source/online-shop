 ...
 */
package com.quackers.qoshop.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(QoshopFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(QoshopFulfilmentProcessConstants.PARENT_PROCESS);
