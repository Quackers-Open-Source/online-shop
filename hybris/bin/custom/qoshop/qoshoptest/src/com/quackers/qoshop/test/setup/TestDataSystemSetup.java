 ...
 */
package com.quackers.qoshop.test.setup;
...
import com.quackers.qoshop.test.constants.QoshopTestConstants;
import com.quackers.qoshop.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = QoshopTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/qoshoptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/qoshoptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/qoshoptest/import/cstickets.impex");
			...
			importImpexFile(context, "/qoshoptest/import/csquotes.impex");
		}
	}
}
